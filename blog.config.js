...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Glorze', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '倚楼听风雨 淡看江湖路', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://glorze.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '高老四博客,程序员,Java,软件源码,影视,音乐,自媒体,短视频,福利分享,美图', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'glorze@glorze.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/Glorze_FX', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/DierMeng', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || 'https://t.me/Glorze88', // 你的telegram 地址 例如 https://t.me/tangly_1024
